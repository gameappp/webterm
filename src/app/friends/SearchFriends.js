  ...
  return (
    <div className="w-full flex flex-col gap-4">
      ...
      <div className="flex items-center text-sm -mb-2">
        <span>جست و جو</span>
        <span className="text-[11px] text-gray-400 pr-0.5 pt-1">
      ...
      >
        <Input
          ...
          endContent={
            loading ? (
              ...
              <button onClick={searchClearHandler}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
        ...
        <div className="w-full flex flex-col gap-3 p-3 border-t border-primaryDarkTheme">
          <h2 className="text-sm bg-gradient-to-b from-white to-gray-400 bg-clip-text text-transparent">
            نتیجه جست و جوی شما
          </h2>
